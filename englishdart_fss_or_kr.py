...
class Handler(Extract, GetPages):
    ...
    def getpages(self, searchquery):
        ...
        self.get_working_tree_api('https://englishdart.fss.or.kr/dsbc001/main.do', 'tree')
        data = {
            'currentPage': '1',
            'maxResults': '45',
            'maxLinks': '5',
        ...
        self.get_working_tree_api('https://englishdart.fss.or.kr/dsbc001/search.ax', 'tree', data=data, method='POST')
        ...
        for link in links:
            ...
            data = {
                'selectKey': link.split('=')[-1],
                'corpDetail': 'Y'
            }
            self.get_working_tree_api('https://englishdart.fss.or.kr/dsbc001/select.ax', 'tree', data=data,
                                      method='POST')
            btn = self.get_by_xpath('//button/text()[contains(., "More detailed Information")]/../@onclick')
            if btn:
    ...
    def get_overview(self, link_name):
        ...
        self.get_address('//label/text()[contains(., "Main Office Address")]/../../following-sibling::td[1]/text()')
        self.fillField('hasLatestOrganizationFoundedDate',
